...
var CreateUserHandler = /** @class */ (function (_super) {
    __extends(CreateUserHandler, _super);
    function CreateUserHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CreateUserHandler.prototype.handle = function (event, context) {
        return __awaiter(this, void 0, void 0, function () {
            var corsResponse, body, userID, user, createdUser, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 7, , 8]);
                        return [4 /*yield*/, UserModel.find({ userID: userID })];
                    case 3:
                        user = _a.sent();
                        if (!(user.length === 0)) return [3 /*break*/, 5];
                        return [4 /*yield*/, UserModel.create({ userID: userID })];
                    case 4:
                        createdUser = _a.sent();
                        return [2 /*return*/, {
                                statusCode: 200,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, createUserHandler.handle(event, context)];
