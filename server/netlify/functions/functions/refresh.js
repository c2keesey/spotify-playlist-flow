...
var RefreshHandler = /** @class */ (function (_super) {
    __extends(RefreshHandler, _super);
    function RefreshHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RefreshHandler.prototype.handle = function (event, context) {
        return __awaiter(this, void 0, void 0, function () {
            var corsResponse, body, refreshToken, data, resBody, err_1, resBody;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.spotifyApi.refreshAccessToken()];
                    case 2:
                        data = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, refreshHandler.handle(event, context)];
